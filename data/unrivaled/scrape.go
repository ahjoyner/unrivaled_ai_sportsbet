...
func main() {
	...
	req, err := http.NewRequest("GET", "https://api.prizepicks.com/projections?league_id=288&per_page=250&single_stat=true", nil)
	if err != nil {
		log.Fatal(err)
	}
	...
	f, err := os.Create("data/unrivaled/unr_bets.json")
